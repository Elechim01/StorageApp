            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack{
                    VStack{
                        ...
                        VStack(spacing: 12){
//                                Files...
                        FilesView(fileName: "Michele.jpg", fileSize: "8 MB", fileImage: "photo")
                        
                        FilesView(fileName: "Apple.m4p", fileSize: "8 MB", fileImage: "play.rectangle.fill")
                        
                        FilesView(fileName: "WWDC.jpg", fileSize: "8 MB", fileImage: "photo")
                        
                        FilesView(fileName: "SwiftUI 3.0.jpg", fileSize: "8 MB", fileImage: "play.rectangle.fill")
                        }
                    }
                    .padding()
//                            max Width...
